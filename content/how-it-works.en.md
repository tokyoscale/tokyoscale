...
1. Stabilization and instrumentation (truth before guesses).  
2. Remove repetitive failure patterns (papercuts erode morale).  
3. Scale what keeps trust intact (compound where adoption is proven).  
